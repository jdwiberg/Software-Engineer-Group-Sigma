...
2. login shopper (Jake and Tim)
3. show account dashboard (Jake and Tim)
4. create receipt (J&T)
5. add receipt item
6. Remove receipt item
7. Edit receipt item
...
12. Remove Store Chain (Tyler) // done, needs testing
13. Remove Store (Tyler) // done, needs testing
